...
{
    /// <summary>
    /// Custom extension of Microsofts' 
    /// Microsoft.AspNetCore.Routing.<see cref="IdentityApiEndpointRouteBuilderExtensions"/>
    /// for enabling JWT token authentication.
    /// </summary>
    public static class CustomIdentityApiEndpointRouteBuilderExtensions
    {
            ...
            where TUser : class, new()
        {
            ...
            var bearerTokenOptions = endpoints.ServiceProvider.GetRequiredService<IOptionsMonitor<CustomJwtBearerOptions>>();
